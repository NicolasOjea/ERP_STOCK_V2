...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pos.Domain.Entities.Comprobante", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pos.Domain.Entities.Devolucion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pos.Domain.Entities.DevolucionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pos.Domain.Entities.EmpresaDatos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pos.Domain.Entities.NotaCreditoInterna", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pos.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("Pos.Domain.Entities.Sucursal", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.CajaMovimiento", b =>
                {
                    b.HasOne("Pos.Domain.Entities.CajaSesion", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.CajaSesion", b =>
                {
                    b.HasOne("Pos.Domain.Entities.Caja", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.Comprobante", b =>
                {
                    ...
                    b.HasOne("Pos.Domain.Entities.Venta", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.DevolucionItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.Devolucion", null)
                        .WithMany()
                        .HasForeignKey("DevolucionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pos.Domain.Entities.Producto", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.DocumentoCompra", b =>
                {
                    b.HasOne("Pos.Domain.Entities.Proveedor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.DocumentoCompraItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.DocumentoCompra", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.ListaPrecioItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.ListaPrecio", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.OrdenCompraItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.OrdenCompra", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.PreRecepcionItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.DocumentoCompraItem", null)
                        .WithMany()
                        .HasForeignKey("DocumentoCompraItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Pos.Domain.Entities.PreRecepcion", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.Producto", b =>
                {
                    b.HasOne("Pos.Domain.Entities.Categoria", null)
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Pos.Domain.Entities.Marca", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.RecepcionItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.PreRecepcionItem", null)
                        .WithMany()
                    ...
                    b.HasOne("Pos.Domain.Entities.Recepcion", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Domain.Entities.StockMovimientoItem", b =>
                {
                    b.HasOne("Pos.Domain.Entities.StockMovimiento", null)
                        .WithMany()
